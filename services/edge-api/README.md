...
`edge-api` is the public REST entrypoint for web, mobile, and partner clients. It centralizes API versioning, authentication, authorization, request shaping, and context propagation before handing work to internal domain services.
